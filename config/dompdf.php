...
return [
    ...
    'font_dir' => storage_path('fonts/'), // ที่เก็บฟอนต์
    'font_cache' => storage_path('fonts/'), // cache font
    'default_font' => 'thsarabun', // ตั้ง default เป็น thsarabun
    'custom_font_dir' => storage_path('fonts/'),
    'custom_font_data' => [
        'thsarabun' => [
            'R'  => 'THSarabunNew.ttf',    // Regular
            'B'  => 'THSarabunNew-Bold.ttf', // Bold (ถ้ามี)
            'I'  => 'THSarabunNew-Italic.ttf', // Italic (ถ้ามี)
            'BI' => 'THSarabunNew-BoldItalic.ttf', // Bold Italic (ถ้ามี)
        ]
    ],
    /*
    |--------------------------------------------------------------------------
