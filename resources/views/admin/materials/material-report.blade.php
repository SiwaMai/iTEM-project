...
<li>
    ...
    <div class="container mt-4">
        <h3 class="mb-4" style="text-align: center;">รายงานข้อมูลวัสดุ</h3>

        <div class="mb-3">
            <a href="{{ route('admin.materials.material-report-preview') }}" target="_blank" class="btn btn-primary me-2">
        ...
        <table class="table table-bordered table-striped align-middle">
            ...
            <tbody>
                ...
                @empty
                    <tr>
                        <td colspan="5" class="text-center">ไม่มีข้อมูลวัสดุ</td>
                    </tr>
                @endforelse
            </tbody>
        </table>
        @if ($materials instanceof \Illuminate\Pagination\LengthAwarePaginator)
            <div class="d-flex justify-content-center mt-3 gap-2 mb-3">
                @if (!$materials->onFirstPage())
                    <a href="{{ $materials->previousPageUrl() }}" class="btn btn-outline-primary">ก่อนหน้า</a>
                @endif

                <span class="btn btn-outline-secondary disabled">
                    หน้า {{ $materials->currentPage() }} จาก {{ $materials->lastPage() }}
                </span>

                @if ($materials->hasMorePages())
                    <a href="{{ $materials->nextPageUrl() }}" class="btn btn-outline-primary">ถัดไป</a>
                @endif
            </div>
        @endif
    </div>
