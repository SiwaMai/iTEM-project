...
<body>
    ...
    <div class="container mt-5 mb-5">
        <div class="row">
            <div class="col-md-12">
                <h2 class="text-center">เพิ่มข้อมูลครุภัณฑ์</h2>
                <div class="container">
                    <form id="equipmentForm" action="{{ route('admin.equipments.store') }}" method="POST"
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            ...
            equipmentForm.addEventListener('submit', function (event) {
                ...
                formData.set('_method', formMethod.value || 'POST');
