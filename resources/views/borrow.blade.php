...
<body>
    ...
    <div class="container mt-5">
        <h3 class="mb-4">ประวัติการยืมครุภัณฑ์ของคุณ</h3>
        ...
        @if($borrowRequests->isEmpty())
            <div class="alert alert-info">คุณยังไม่มีรายการยืม</div>
        @else
    ...
    @elseif($request->status === 'returned')
        <span class="badge bg-primary">คืนแล้ว</span>
    @else
